...
public class TestConfig {
    ...
    public static final String ALLOWED_DOMAIN = "http://localhost:8000";
    public static final String NOT_ALLOWED_DOMAIN = "http://randomdomain";
    public static final String MEDIA_TYPE_JSON = "application/json";
    public static final String MEDIA_TYPE_XML = "application/xml";
    public static final String BASE_PATH_CLIENT = "/api/client";
    public static final String basePathTask = "/tasks/v1";
    public static final String BASE_PATH_LOGIN = "/api/login";
}
